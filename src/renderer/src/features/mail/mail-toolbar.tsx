      ...
      <div className="flex shrink-0 items-center gap-1.5">
        <Tooltip>
          <TooltipTrigger asChild>
            <Button size="icon" onClick={onCompose} aria-label="Nuovo messaggio" className="size-8">
      ...
      <div className="flex shrink-0 items-center gap-2">
        ...
        <div className="relative w-56">
          <Tooltip>
            ...
            <TooltipContent side="bottom" className="max-w-72 font-normal">
              Cerca in tutti i campi. Usa <b>da:</b> <b>a:</b> <b>oggetto:</b> per restringere a un
              campo, <b>OR</b> per alternative.
            </TooltipContent>
          </Tooltip>
          <Input
            ref={searchInputRef}
          ...
          <Tooltip>
            ...
            <TooltipContent side="bottom">Cancella ricerca</TooltipContent>
          </Tooltip>
        </div>
